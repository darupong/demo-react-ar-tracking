...
/** CTA buttons: Single Target, Single Target Video, Multi Target Tracking. IMAI-style. */
function LandingCTA() {
  return (
    <div className="text-center mb-8 flex flex-col sm:flex-row flex-wrap gap-4 justify-center items-center">
      <Link to={ROUTES.singleTrackingVideo} className={ctaClass}>
      ...
      <Link to={ROUTES.multiTracking} className={ctaClass}>
        <span className="flex items-center gap-2">
          Multi Target Tracking 3D
          <svg className="w-5 h-5 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
          </svg>
        </span>
      </Link>
      <Link to={ROUTES.facemesh} className={ctaClass}>
        <span className="flex items-center gap-2">
          Face Mesh
          <svg className="w-5 h-5 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
